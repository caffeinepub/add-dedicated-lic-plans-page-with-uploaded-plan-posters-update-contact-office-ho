...
import { MaturityCalculatorForm } from '../components/calculators/MaturityCalculatorForm';
import { MaturityResultsDisplay } from '../components/calculators/MaturityResultsDisplay';
import { useGetAllLICPlans } from '../hooks/useLICPlans';
import { Skeleton } from '@/components/ui/skeleton';
import { Alert, AlertDescription } from '@/components/ui/alert';

function MaturityCalculatorPageContent() {
  const { t } = useLanguage();
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground">
              {t({ mr: 'परिपक्वता कॅल्क्युलेटर', hi: 'परिपक्वता कैलकुलेटर', en: 'Maturity Calculator' })}
            </h1>
            <LanguageToggle />
          </div>
        </div>
